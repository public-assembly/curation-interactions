export const curatorAbi = [
  ...
  { inputs: [], name: 'ACCESS_NOT_ALLOWED', type: 'error' },
  { inputs: [], name: 'ADDRESS_ZERO', type: 'error' },
  { inputs: [], name: 'ALREADY_INITIALIZED', type: 'error' },
  { inputs: [], name: 'CANNOT_SET_SAME_PAUSED_STATE', type: 'error' },
  { inputs: [], name: 'CANNOT_UPDATE_CURATION_LIMIT_DOWN', type: 'error' },
  ...
  { inputs: [], name: 'TOKEN_HAS_NO_OWNER', type: 'error' },
  { inputs: [], name: 'TOO_MANY_ENTRIES', type: 'error' },
  { inputs: [], name: 'UNSUPPORTED_UUID', type: 'error' },
  {
    inputs: [
      { internalType: 'address', name: 'setCurator', type: 'address' },
      { internalType: 'address', name: 'expectedCurator', type: 'address' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'int32[]', name: 'sorts', type: 'int32[]' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_curationPass', type: 'address' },
      ...
      { internalType: 'bytes', name: '_rendererInitializer', type: 'bytes' },
      {
        components: [
          { internalType: 'address', name: 'curatedAddress', type: 'address' },
          { internalType: 'uint96', name: 'selectedTokenId', type: 'uint96' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'checkTokenId', type: 'uint256' },
    ],
    name: 'transferFrom',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'int32[]', name: 'sortOrders', type: 'int32[]' },
    ],
